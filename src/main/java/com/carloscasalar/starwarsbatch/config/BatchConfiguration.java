package com.carloscasalar.starwarsbatch.config;

import com.carloscasalar.starwarsbatch.tasklet.HelloWorldTasklet;
...
public class BatchConfiguration {
    ...
    public Step helloWorldStep(StepBuilderFactory stepBuilderFactory, HelloWorldTasklet helloWorldTasklet) {
        return stepBuilderFactory.get("helloWorldTasklet")
